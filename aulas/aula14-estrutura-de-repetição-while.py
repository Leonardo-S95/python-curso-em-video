#for pode ser mais interessante quando se sabe o limite (Ex: eu sei que tenho que dar 20 passos.).
#Se não souber o limite, o for não funciona. Aí entra o while.
...
Ex: 0 → 1 → 1 → 2 → 3 → 5 → 8
            ...
            DESAFIO 064
Crie um programa que leia vários números inteiros pelo teclado. O programa só vai parar quando o usúario digitar o
